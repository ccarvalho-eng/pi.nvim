...
local function set_defaults()
    ...
    vim.api.nvim_set_hl(0, "PiStatusLineActivity", { default = true, fg = agent.fg, bold = true })
    vim.api.nvim_set_hl(0, "PiStatusLineKey", { default = true, fg = normal.fg, bold = true })
